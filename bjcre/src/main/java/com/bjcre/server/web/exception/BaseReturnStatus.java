...
public enum BaseReturnStatus {
     ...
     *            the desc
     */
    private BaseReturnStatus(int value, String desc) {
        this.value = value;
        this.desc = desc;
    }
    ...
    static {
        ...
        hashSet.clear();
        for (BaseReturnStatus returnStatus : BaseReturnStatus.values()) {
    ...
    public static BaseReturnStatus get(int value) {
        for (BaseReturnStatus o : BaseReturnStatus.values()) {
            if (value == o.getValue()) {
                return o;
            }
        }
